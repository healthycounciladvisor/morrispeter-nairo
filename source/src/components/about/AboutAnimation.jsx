            ...
            >
              <div className="about-info">
                ...
                <div className="about-text">
                  ...
                  <p>
                  My development includes the experience of scraping data in any format desired by the client using a perfect web scraping API from various data management websites such as bond sites and eBay. 
                  I've always been responsible for backend, frontend and database design on every project..
                  </p>
                </div>
